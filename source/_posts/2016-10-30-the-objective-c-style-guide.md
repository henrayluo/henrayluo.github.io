title: 无规矩 不成方圆
date: 2016-10-30 15:54:12
tags:
---

经历过几个项目，看过一些代码后。如果还没有代码洁癖，那...我不希望和你一起 Work Or Play。之前找过 Objective-C 代码规范，发现谷歌的 Objective-C 代码规范页面 404 啦，然后看了下 Linux 内核代码。虽然是 c 语言的代码，但那种每行都在 80 个字符之内，能在各种设备上阅读的愉悦感，肯定能使你下定决心写一手干净利索的代码。无规矩，不成方圆。现在终于找到一篇比较全的 [Wordpress Mobile apps](https://github.com/wordpress-mobile/WordPress-iOS) 代码规范,贴上来和大家分享一下。
...
Using logical operators with _BOOL_ is also valid and will return values that can be safely converted to _BOOL_ without the need for a ternary operator.
